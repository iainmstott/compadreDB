...
load("DBVersionsCurrent/COMPADRE_v4.0.1.Rdata")
...
# load the phylogeny
load("GeneratePhylogeny/GeneratedTrees/20180728_compadrePhylogeny.Rdata")

# save the .Rdata object
save.image("DBVersionsClean/compadre_v4.0.1_Clean.Rdata")
